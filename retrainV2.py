...
#    a) read a JSON file containing the groups and imageURIs
#    b) write the result data structure to acess images through a service 
#  
...
def create_bottleneck_file(bottleneck_path, image_lists, label_name, index,
  ...
  # TODO remove this check as we use a image service
  ...
  # #################################################################################
  # TODO
  # thats the only position for the image read
  # there are two possible solutions
  # 
  #  a) copy the file from the WSI server to a local, temporary file and read this with  gfile.FastGFile
  #  b) use this code snipplet
  # 
...
def main(_):
  ...
  #
  # TODO, here we have to adapt to the new image_list structure
  #
